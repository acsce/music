            ...
            <div class="box round first">
                ...
                <div class="block">
                   <form name="form1" action="" method="post" enctype="multipart/form-data">
					...
					<tr>
					<td><b>Music Title6::</b></td>
					<td><input type="text" name="mt6" ></td>
					
					<td><b>Audio6::</b></td>
					<td><input type="file" name="a6" ><br><br></td>
					</tr>	
					<tr>
...
if(isset($_POST["submit1"]))
{
   ...
   move_uploaded_file($_FILES["a6"]["tmp_name"],$dst7);

mysqli_query($link,"INSERT INTO music_add(`ID`, `film_name`, `music_lang`, `music_image`, `music_title1`, `audio1`, `music_title2`, `audio2`, `music_title3`, `audio3`, `music_title4`, `audio4`, `music_title5`, `audio5`,`music_title6`, `audio6`) VALUES ('','$_POST[moname]','$_POST[lang]','$dst1','$_POST[mt1]','$dst2','$_POST[mt2]','$dst3','$_POST[mt3]','$dst4','$_POST[mt4]','$dst5','$_POST[mt5]','$dst6','$_POST[mt6]','$dst7')");
